...
public class MyComplaints extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String userToken = StorageHandler.getDefaults("userToken", MyComplaints.this);
        String userSessionToken = StorageHandler.getDefaults("userSessionToken", MyComplaints.this);

        APIManagerSingleton.getApiManager(MyComplaints.this).getListOfComplaint(userToken, userSessionToken,  true, new MyComplaintsListener() {
            @Override
            public void onResponse(List<Complaint> complaintList) {
                LodgedComplaintAdapter lodgedComplaintAdapter = new LodgedComplaintAdapter(MyComplaints.this, complaintList);
                complaintListView.setAdapter(lodgedComplaintAdapter);

                complaintListView.setOnItemClickListener((adapterView, view, i, l) -> {
                    Intent complaintDetails = new Intent(MyComplaints.this, ComplaintDetails.class);
            ...
            public void onError(String error) {
                Toast.makeText(MyComplaints.this, error, Toast.LENGTH_LONG).show();
            }
        });
    }
